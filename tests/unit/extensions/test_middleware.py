...
from llm_kernel.runtime import ExecutionResult
...
class TestMiddlewareChain:
    ...
    def test_empty_chain_passes_through(
        self, sample_request, sample_plan, sample_response, sample_result
    ):
    ...
    def test_multiple_extensions_called_in_order(
        self, sample_request, sample_plan, sample_response, sample_result
    ):
        ...
        class TaggingExtension(Extension):
            ...
            def on_request(self, request: Request) -> Request:
                ...
                return request.model_copy(
                    update={"metadata": {**request.metadata, "tags": [*self.seen_metadata, "tag"]}}
                )

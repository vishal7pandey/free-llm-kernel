...
class TestUsageStore:
    ...
    def test_record_usage_accumulates(self, tmp_usage_file: Path):
        ...
        store.record("groq", "llama-3.3-70b", Usage(prompt_tokens=20, completion_tokens=10, total_tokens=30))
    ...
    def test_record_multiple_providers(self, tmp_usage_file: Path):
        ...
        store = UsageStore(path=tmp_usage_file)
        store.record("groq", "llama-3.3-70b", Usage(prompt_tokens=10, completion_tokens=5, total_tokens=15))
        store.record("google", "gemini-2.0-flash", Usage(prompt_tokens=8, completion_tokens=4, total_tokens=12))
    ...
    def test_loads_from_disk(self, tmp_usage_file: Path):
        ...
        store1.record("groq", "llama-3.3-70b", Usage(prompt_tokens=10, completion_tokens=5, total_tokens=15))
    ...
    def test_get_today_filters_by_date(self, tmp_usage_file: Path):
        ...
        # Record today
        store.record("google", "gemini-2.0-flash", Usage(prompt_tokens=10, completion_tokens=5, total_tokens=15))
